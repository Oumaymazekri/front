      ...
      <div className="relative z-20 h-full flex items-center">
        <div className="container mx-auto px-8">
          <div className="max-w-xl space-y-8">
            ...
            <button className="px-10 py-5 bg-black text-white rounded-full hover:bg-gray-800 transition-all duration-300 font-medium tracking-wide text-lg transform hover:scale-105">
              Shop Collection
            </button>
