    ...
    <div className="about-container">
      ...
      <section className="about-info">
        <div className="info-card">
          <h2>Notre Mission</h2>
          <p>Nous avons pour mission de vous offrir une gamme variée et de qualité d'accessoires pour téléphones afin de répondre à vos besoins quotidiens en matière de technologie et d'innovation.</p>
        </div>
        <div className="info-card">
